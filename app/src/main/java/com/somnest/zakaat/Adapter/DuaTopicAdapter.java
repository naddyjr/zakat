package com.somnest.zakaat.Adapter;
...
public class DuaTopicAdapter extends RecyclerView.Adapter<DuaTopicAdapter.AlbumViewHolder> {
    ...
    public void onBindViewHolder(AlbumViewHolder albumViewHolder, int i) {
        albumViewHolder.tvTopicName.setText(this.list.get(i).getTopicName());
        Log.e("MYTAG", "ErrorNo: onBindViewHolder: " +this.list.get(i).getImageFilePath());
        String s = this.list.get(i).getImageFilePath();
    ...
    public class AlbumViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View view) {
            DuaTopicAdapter.this.onItemClickListener.OnClick(view, getLayoutPosition());
        }
    }
}
