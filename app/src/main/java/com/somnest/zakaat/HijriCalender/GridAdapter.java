package com.somnest.zakaat.HijriCalender;
...
public class GridAdapter extends BaseAdapter {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (cursor1.moveToFirst()){
            do{
                String data = cursor1.getString((int)cursor1.getColumnIndex("DAY"));
        ...
        if (cursor2.moveToFirst()){
            do{
                String data = cursor2.getString((int)cursor2.getColumnIndex("MONTH"));
        ...
        if (cursor3.moveToFirst()){
            do{
                String data = cursor3.getString((int)cursor3.getColumnIndex("YEAR"));
        ...
        if (cursor4.moveToFirst()){
            do{
                String data = cursor4.getString((int)cursor4.getColumnIndex("EVENT"));
        ...
        cursor4.close();
        view2.setMinimumHeight(HijriCalenderActivity.height / 11);
        ...
        if (textView1.getText().toString().equals(val1) && month2string.equals(mytxt) && year2string.equals(mytxt2)) {
            view2.setBackgroundResource(R.drawable.round_border_square);
            Calendar mcalendar = Calendar.getInstance();
            DateTime dtISO1 = new DateTime(mcalendar.get(Calendar.YEAR), mcalendar.get(Calendar.MONTH) + 1, Integer.parseInt(textView1.getText().toString()), 0, 0); 
            ...
            String islamic_month_name3 = HijriCalenderActivity.all_hijri_months.get(Integer.parseInt(islamicmonth2));
            ...
            if (textView2.getText().toString().equals("1")) {
                if (textView1.getText().toString().equals(val1) && month2string.equals(mytxt) && year2string.equals(mytxt2)) {
                    ...
                    DateTime dtISO = new DateTime(yr, month, Integer.parseInt(textView1.getText().toString()), 0, 0); 
                    ...
                    String islamic_month_name1 = HijriCalenderActivity.all_hijri_months.get(Integer.parseInt(islamicmonth));
        ...
        if (textView2.getText().toString().equals("1")) {
            ...
            if (textView1.getText().toString().equals(val1) && month2string.equals(mytxt) && year2string.equals(mytxt2)) {
                ...
                ((LinearLayout) this.view2.findViewById(R.id.llTodayBadge)).setVisibility(View.VISIBLE);
    ...
    private void datechoser(final String events, final int yr, final int month, int day, String islamicday, String islam_month_int) {
        ...
        if (day != 0) {
            DateTime dtISO = new DateTime(yr, month, day, 0, 0); 
            DateTime dtIslamic = dtISO.withChronology(IslamicChronology.getInstance());
            String islamicmonth = Integer.toString(dtIslamic.getMonthOfYear());
            String islamicyr = Integer.toString(dtIslamic.getYear());
            ...
            if (textView2.getText().toString().equals(islamicday) && islamicmonth.equals(islam_month_int)) {
                if (textView1.getText().toString().equals(val1) && month2string.equals(mytxt) && year2string.equals(mytxt2)) {
                    ...
                    SharedPreferences prefs = context.getSharedPreferences("UserData", MODE_PRIVATE);
                    SharedPreferences.Editor editor = prefs.edit();
                    editor.putString("islamicmonth", HijriCalenderActivity.all_hijri_months.get(Integer.parseInt(islamicmonth)));
                    editor.putString("islamicday", textView2.getText().toString());
                    editor.putString("islamicyr", islamicyr);
    ...
    private void datechoser_reminder(final String events, final String yr, final String month, String day) {
        ...
        final DateTime dtISO = new DateTime(Integer.parseInt(yr), Integer.parseInt(month), Integer.parseInt(day), 0, 0); 
